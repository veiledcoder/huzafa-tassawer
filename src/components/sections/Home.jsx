...
export const Home = () => {
  return (
    <section id="home" className="flex flex-row flex-wrap items-center justify-between px-6 lg:px-24 py-16 md:pt-20 lg:pt-20 gap-y-10">
      ...
      >
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-tight">
