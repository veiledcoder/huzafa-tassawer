...
export const Home = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-center px-4 md:px-12 py-4 md:py-10 gap-0 md:gap-8"
    >
      {/* Left Side - Text */}
      <motion.div
      ...
      >
        <h1 className="text-4xl sm:text-3xl lg:text-5xl font-bold bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-tight mb-2">
          Hi, I'm Syed Huzafa Tassawer
        </h1>

        <p className="text-gray-500 text-base sm:text-lg md:text-xl max-w-xl mx-auto md:mx-0 mb-4">
      ...
      >
        <img
          ...
          className="w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96 rounded-2xl shadow-xl hover:shadow-2xl transition duration-500 hover:scale-105 object-cover object-center mx-auto"
        />
      </motion.div>
    </section>
  );
